...
export const toggleDruidicWarriorBtnStyle = makeStyles(() => ({
  addButton: {
    fontSize: "12px",
    padding: "2px 10px",
    borderRadius: "4px",
...
export const PrepareDruidicWarriorCantripButton = ({ spell, index = 0 }) => {
  ...
  const classes = toggleDruidicWarriorBtnStyle();
...
export default PrepareDruidicWarriorCantripButton;
