...
export const toggleBlessedWarriorBtnStyle = makeStyles(() => ({
  addButton: {
    fontSize: "12px",
    padding: "2px 10px",
    borderRadius: "4px",
...
export const PrepareBlessedWarriorCantripButton = ({ spell, index = 0 }) => {
  ...
  const classes = toggleBlessedWarriorBtnStyle();
...
export default PrepareBlessedWarriorCantripButton;
